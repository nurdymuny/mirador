...
function buildDrugs() {
  ...
  // Endocarditis: vegetation (NVE) + vegetation_pve (PVE, K_biofilm=2.0)
  ...
  // Meningitis + dexamethasone: csf_inflamed + csf_dex
  ...
  // Intra-abdominal abscess: peritoneal + abscess_capsule
