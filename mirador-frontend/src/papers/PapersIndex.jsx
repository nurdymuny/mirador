...
export const PAPERS = [
  ...
  },
  {
    ...
    color: C.amber,
    summary: 'Geometry predicts the REMoxTB trial failure: MXF↔RIF rank inversion in caseum means MXF-replacing-RIF arm cannot suppress sterilizing-phase relapse. Four predictions, four matches.',
  },
  {
    id: 'letendre-2010',
